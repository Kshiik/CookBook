...
--
-- Хост: MySQL-5.7
-- Время создания: Дек 07 2024 г., 23:53
...
INSERT INTO `favorites` (`id_favorite`, `user_id`, `recipe_id`) VALUES
(1, 5, 2),
(2, 5, 5);
...
INSERT INTO `recipes` (`id_recipe`, `name_recipe`, `img_recipe`, `cooking_time`, `cooking_time_minutes`, `servings`, `calories`) VALUES
(1, 'Японское карри', 'assets/img/jarkoe.png', '1 час', 60, 4, 147),
(2, 'Хинкали', 'assets/img/hinkali.jpg', '3 часа', 180, 15, 183),
(3, 'Баклажаны жареные с помидорами', 'assets/img/baklaznany.jpg', '30 мин', 30, 4, 177),
(4, 'Кролик в пиве', 'assets/img/krolik-v-pive.webp', '1.5 часа', 90, 8, 440),
(5, 'Оливье по-советски', 'assets/img/olivier.jpg', '1 час', 60, 10, 417),
(6, 'Французские гренки с фруктами', 'assets/img/francuzskie-grenki-s-fruktam.webp', '40 мин', 40, 4, 439),
(7, 'Малиновый лимонад с мятой', 'assets/img/lemonade-drink.jpg', '30 мин', 30, 8, 84),
(8, 'Гусь в духовке', 'assets/img/gus-v-duhovke.webp', '3.5 часа + 8 часов', 690, 6, 352),
(9, 'Тыквенный суп пюре', 'assets/img/pumpkin-soup (1).jpg', '45 мин', 45, 4, 418),
(10, 'Бутер (авторский рецепт)', 'assets/img/buter.jpg', '5 мин', 5, 1, 1),
(11, 'Бельгийские вафли с мороженным и взбитыми сливками', 'assets/img/vafli.jpg', '40 мин', 40, 5, 705),
(12, 'Печеная брюссельская капуста с чесноком', 'assets/img/zbk.jpg', '30 мин', 30, 4, 153);
...
(1, 'admin', '$2y$10$EBGehz.mKte.PThVaeGq6euj0lrVJ76Ww/al5vp.iyRrZUxRmEwuC', NULL, NULL, '', 1),
(2, 'qwe', '$2y$10$m4UyLkGXzwEw6DNSJNdFAOlaLkH866Bx0DHFbTnMvFjjkmF.p0nJy', 'qwew@ewwe.trh', NULL, '', 2),
(3, 'aaa', '$2y$10$Fjo0rJsCdiEZScZGSC22guSzIIcyGP5GcpgiqMTBSVKgYaZAc5eH.', 'aaa@gmail.com', NULL, NULL, 2),
(4, 'ф', '$2y$10$sunVQyyo36pzFCVXZD9JCOOMa6fh.EtREbP7GKnOAM54LNFVN9zPi', 'asd@gmail.com', 'иии', 'ссс', 2),
